...
# JsHint STDOUT test
log/jshint.log: log/npm-dev-install.log lib/string.js test/string-test.js
	${JSHINT} lib/string.js test/string-test.js | tee log/jshint.log ; exit $${PIPESTATUS[0]}

# Mocha BDD STDOUT test
log/mocha.log: log/npm-dev-install.log lib/string.js test/string-test.js
	${MOCHA} test/string-test.js -R spec | tee log/mocha.log ; exit $${PIPESTATUS[0]}
...
bdd-spec.md: log/npm-dev-install.log lib/string.js test/string-test.js
	${MOCHA} test/string-test.js -R markdown > bdd-spec.md

# Upgrade version in package.json
log/upgrade-package.log: lib/string.js test/string-test.js documentation.md
...
log/github-push.log: lib/string.js test/string-test.js package.json
