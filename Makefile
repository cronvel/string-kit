...
# JsHint STDOUT test
log/jshint.log: log/npm-dev-install.log lib/*.js test/string-test.js
	${JSHINT} lib/*.js test/string-test.js | tee log/jshint.log ; exit $${PIPESTATUS[0]}

# Mocha BDD STDOUT test
log/mocha.log: log/npm-dev-install.log lib/*.js test/string-test.js
...
bdd-spec.md: log/npm-dev-install.log lib/*.js test/string-test.js
	${MOCHA} test/string-test.js -R markdown > bdd-spec.md

# Upgrade version in package.json
log/upgrade-package.log: lib/*.js test/string-test.js documentation.md
...
log/github-push.log: lib/*.js test/string-test.js package.json
